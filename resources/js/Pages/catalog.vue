        ...
        <Head title="Index of Motorcycles" />
            ...
            <div class="col-sm-8 col-lg-5 col-xl-3 offset-xl-1 order-sm-2 mb-3 mb-sm-0">
                <div class="position-relative mb-lg-2 d-flex align-items-center">
                    ...
                    <input class="form-control rounded-pill flex-grow-1" type="search" placeholder="Enter keywords.." v-model="search">
                </div>
                ...
                <div class="container1">
                    <div class="row">
                        ...
                        <div class="col-lg-6 py-lg-4 ps-lg-5">
                            <img :src="getImagePath(motor)" :alt="motor.model" class="img img-fluid fixed-height-image">
                        </div>
                        <!-- Second Column -->
                        <div class="col-lg-6 py-lg-4 ps-lg-5">
                            <div class="row">
                                ...
                                <Link :href="route('motorcycle.show', motor.id)" class="btn-2 h4 w-50 d-flex align-items-center justify-content-center" style="text-decoration: none; padding: 5px;"
...
.container1{
    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;padding: 20px;
}
</style>
