            ...
            <div class="row">
                ...
                <Layout />
                    <div class="ms-auto mt-n1 col-auto pe-3 mt-3 my-5">
                                <div class="row">
                                        <div class="col-5 p-4 p-md-8  shadow-sm rounded w-75">
                                            <section class="max-w-xl ms-5">
                                                <header>
                                                ...
                                                <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6 ms-5">
